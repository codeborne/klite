...
class JsonRendererTest {
  ...
  @Test fun classes() {
    ...
    expect(mapper.render(o)).toEqual(/*language=JSON*/ """{"array":[{"x":0,"y":123},{"x":0,"y":123}],"date":"2022-10-21","hellou":"","id":"b8ca58ec-ab15-11ed-93cc-8fdb43988a14","instant":"2022-10-21T10:55:00Z","map":{},"nested":{"x":567,"y":123},"readOnly":true}""")
  }
